...
// summaries. Summary implements both PlatformCollector and ObserverMetric
//
...
// setPrometheusSummary sets the underlying Gauge object, i.e. the thing that does the measurement.
...
// NewSummaryVec returns an object which satisfies PlatformCollector and wraps the
