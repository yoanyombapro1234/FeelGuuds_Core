...
// counters. Counter implements both PlatformCollector and CounterMetric.
type Counter struct {
	CounterMetric
	*CounterOpts
	lazyMetric
...
// NewCounter returns an object which satisfies the PlatformCollector and CounterMetric interfaces.
...
// counterVecs. CounterVec implements both PlatformCollector and CounterVecMetric.
...
// NewCounterVec returns an object which satisfies the PlatformCollector and CounterVecMetric interfaces.
// However, the object returned will not measure anything unless the collector is first
// registered, since the metric is lazily instantiated.
