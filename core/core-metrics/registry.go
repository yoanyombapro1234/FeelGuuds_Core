...
var (
	...
	registries     []*platformRegistry // stores all registries created by NewPlatformRegistry()
...
// platformRegistry is a wrapper around a prometheus registry-type object. Upon initialization
// the binary version information is loaded into the registry object, so that
...
func (kr *platformRegistry) Register(c Registerable) error {
...
// error.
func (kr *platformRegistry) MustRegister(cs ...Registerable) {
...
func (kr *platformRegistry) CustomRegister(c StableCollector) error {
...
// error.
func (kr *platformRegistry) CustomMustRegister(cs ...StableCollector) {
...
//
// Deprecated
func (kr *platformRegistry) RawMustRegister(cs ...prometheus.Collector) {
...
func (kr *platformRegistry) addResettable(i interface{}) {
	kr.resetLock.Lock()
...
func (kr *platformRegistry) Unregister(collector Collector) bool {
...
func (kr *platformRegistry) Gather() ([]*dto.MetricFamily, error) {
	return kr.PromRegistry.Gather()
}

// trackHiddenCollector stores all hidden collectors.
func (kr *platformRegistry) trackHiddenCollector(c Registerable) {
...
func (kr *platformRegistry) trackStableCollectors(cs ...StableCollector) {
...
func (kr *platformRegistry) enableHiddenCollectors() {
...
func (kr *platformRegistry) enableHiddenStableCollectors() {
...
func (kr *platformRegistry) Reset() {
	kr.resetLock.RLock()
...
func newPlatformRegistry(v apimachineryversion.Info) *platformRegistry {
	r := &platformRegistry{
...
func NewPlatformRegistry() *platformRegistry {
	r := newPlatformRegistry(BuildVersion())
	return r
}
