...
var (
	buildInfo = NewGaugeVec(
		&GaugeOpts{
			Name:           "blackspace build_info",
			Help:           "A metric with a constant '1' value labeled by major, minor, git version, git commit, git tree state, build date, Go version, and compiler from which blackspae was built, and platform on which it is running.",
